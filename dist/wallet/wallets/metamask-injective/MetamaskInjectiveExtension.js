...
import { base16, base64, ethhex, utf8 } from "../../../codec/index.js";
import { CosmosTxSigningV1beta1SignMode as SignMode, InjectiveTypesV1beta1ExtensionOptionsWeb3Tx as Web3Tx, } from "../../../protobufs/index.js";
...
export class MetamaskInjectiveExtension extends ConnectedWallet {
    constructor(walletName, ext, chainId, pubKey, ethAddress, bech32Address, rpc, gasPrice) {
        super(walletName, WalletType.EXTENSION, chainId, pubKey, bech32Address, rpc, gasPrice);
        this.ext = ext;
        this.ethAddress = ethAddress;
    }
    async signArbitrary(data) {
        const signature = await this.ext.request({
    ...
    async signAndBroadcastTx({ msgs, memo = "", timeoutHeight = 1000000000000000n }, fee, accountNumber, sequence) {
        const tx = new Tx({
...
//# sourceMappingURL=MetamaskInjectiveExtension.js.map