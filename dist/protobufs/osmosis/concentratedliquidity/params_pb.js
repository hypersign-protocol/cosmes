...
class Params extends Message {
    constructor(data) {
         ...
         */
        this.isPermissionlessPoolCreationEnabled = false;
        /**
         ...
         */
        this.unrestrictedPoolCreatorWhitelist = [];
        /**
         * @generated from field: uint64 hook_gas_limit = 8;
         */
        this.hookGasLimit = protoInt64.zero;
...
Params.typeName = "osmosis.concentratedliquidity.Params";
