...
class RecoveredSinceDowntimeOfLengthRequest extends Message {
    constructor(data) {
         ...
         */
        this.downtime = Downtime.DURATION_30S;
...
RecoveredSinceDowntimeOfLengthRequest.runtime = proto3;
RecoveredSinceDowntimeOfLengthRequest.typeName = "osmosis.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthRequest";
RecoveredSinceDowntimeOfLengthRequest.fields = proto3.util.newFieldList(() => [
...
class RecoveredSinceDowntimeOfLengthResponse extends Message {
    constructor(data) {
         ...
         */
        this.succesfullyRecovered = false;
        proto3.util.initPartial(data, this);
    }
    static fromBinary(bytes, options) {
...
RecoveredSinceDowntimeOfLengthResponse.runtime = proto3;
RecoveredSinceDowntimeOfLengthResponse.typeName = "osmosis.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthResponse";
