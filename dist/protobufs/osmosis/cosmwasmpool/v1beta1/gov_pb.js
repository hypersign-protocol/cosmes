...
UploadCosmWasmPoolCodeAndWhiteListProposal.runtime = proto3;
UploadCosmWasmPoolCodeAndWhiteListProposal.typeName = "osmosis.cosmwasmpool.v1beta1.UploadCosmWasmPoolCodeAndWhiteListProposal";
UploadCosmWasmPoolCodeAndWhiteListProposal.fields = proto3.util.newFieldList(() => [
...
class MigratePoolContractsProposal extends Message {
    constructor(data) {
         ...
         */
        this.newCodeId = protoInt64.zero;
        /**
         ...
         */
        this.migrateMsg = new Uint8Array(0);
        proto3.util.initPartial(data, this);
    }
    static fromBinary(bytes, options) {
...
MigratePoolContractsProposal.runtime = proto3;
MigratePoolContractsProposal.typeName = "osmosis.cosmwasmpool.v1beta1.MigratePoolContractsProposal";
MigratePoolContractsProposal.fields = proto3.util.newFieldList(() => [
    { no: 1, name: "title", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
